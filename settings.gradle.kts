dependencyResolutionManagement {
    versionCatalogs {
        create("deps") {
            ...
            version("sqliteJdbcLibVersion", "3.50.3.0") // https://central.sonatype.com/artifact/org.xerial/sqlite-jdbc
            version("jacksonLibVersion", "2.20.0") // https://central.sonatype.com/artifact/com.fasterxml.jackson.core/jackson-core
            version("osgiAnnotationLibVersion", "8.1.0") // https://central.sonatype.com/artifact/org.osgi/osgi.annotation
            version("quarkusGraalvmceBuilderImage", "quay.io/quarkus/ubi-quarkus-graalvmce-builder-image:jdk-25") // https://quay.io/quarkus/ubi-quarkus-graalvmce-builder-image?tab=tags
            ...
            library("libs.quarkus.container.image.docker", "io.quarkus", "quarkus-container-image-docker").versionRef("quarkusLibVersion")
